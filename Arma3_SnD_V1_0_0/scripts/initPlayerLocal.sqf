player createDiaryRecord ["Diary", ["Search and Destroy","
	<br/>BLUFOR: Defend the bomb site at the red marker for 5 minutes. Eliminate the INDEPENDENT before they plant the bomb. If the bomb is planted you have 40 seconds to defuse the bomb (takes 5 seconds to defuse). 
	<br/>
	...
	<br/>
	<br/>START OF ROUND: Everyone can't move for the first 10 seconds, then the round lasts 5 minutes (unless the bomb is planted, which extends the round by 45 seconds). The dead become spectators. BLUFOR is not allowed to cross the red line on the map.
"]];
...
player createDiaryRecord ["missionSettings", ["Mission Settings","
	...
	<br/>Mission Time (Without Plant, includes Start Time): 310 seconds 
